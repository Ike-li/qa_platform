...
> 更新于 2026-06-05（PRD / catalog / tasks 与代码的历史偏移审计见 [`archive/doc-conflict-audit.md`](archive/doc-conflict-audit.md)；旧 `feature/T*` 分支合并状态仅作为审计快照保留，当前实现与 backlog 以本文件、catalog 和现场 git 状态为准）
