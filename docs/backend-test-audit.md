...
- integration 收集：168 tests
- PR/push 必跑 required integration：132 passed, 36 deselected
- 完整 local integration（未启动外部 API/worker 栈）：140 passed, 28 skipped
