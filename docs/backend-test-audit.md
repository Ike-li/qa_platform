...
- integration 收集：185 tests
- PR/push 必跑 required integration：138 passed, 47 deselected
- 完整 local integration（未启动外部 API/worker 栈）：最近记录为 146 passed, 37 skipped；本轮只重跑 collect-only、required integration 与 performance lane
- performance smoke opt-in：31 passed
