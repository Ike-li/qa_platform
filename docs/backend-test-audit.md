...
- integration 收集：173 tests
- PR/push 必跑 required integration：134 passed, 39 deselected
- 完整 local integration（未启动外部 API/worker 栈）：142 passed, 31 skipped
