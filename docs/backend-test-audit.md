...
- integration 收集：174 tests
- PR/push 必跑 required integration：135 passed, 39 deselected
- 完整 local integration（未启动外部 API/worker 栈）：143 passed, 31 skipped
- performance smoke opt-in：24 passed
