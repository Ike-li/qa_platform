...
- integration 收集：172 tests
- PR/push 必跑 required integration：134 passed, 38 deselected
- 完整 local integration（未启动外部 API/worker 栈）：142 passed, 30 skipped
- performance smoke opt-in：23 passed
