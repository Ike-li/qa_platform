...
- integration 收集：182 tests
- PR/push 必跑 required integration：138 passed, 44 deselected
- 完整 local integration（未启动外部 API/worker 栈）：146 passed, 36 skipped
- performance smoke opt-in：29 passed
