...
- integration 收集：175 tests
- PR/push 必跑 required integration：135 passed, 40 deselected
- 完整 local integration（未启动外部 API/worker 栈）：143 passed, 32 skipped
