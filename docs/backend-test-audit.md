...
- integration 收集：171 tests
- PR/push 必跑 required integration：134 passed, 37 deselected
- 完整 local integration（未启动外部 API/worker 栈）：142 passed, 29 skipped
- performance smoke opt-in：22 passed
