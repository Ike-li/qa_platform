...
- integration 收集：181 tests
- PR/push 必跑 required integration：138 passed, 43 deselected
- 完整 local integration（未启动外部 API/worker 栈）：146 passed, 35 skipped
