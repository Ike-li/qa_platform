...
- integration 收集：166 tests
- PR/push 必跑 required integration：130 passed, 36 deselected
- 完整 local integration（未启动外部 API/worker 栈）：138 passed, 28 skipped
