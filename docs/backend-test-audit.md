...
- integration 收集：170 tests
- PR/push 必跑 required integration：134 passed, 36 deselected
- 完整 local integration（未启动外部 API/worker 栈）：142 passed, 28 skipped
- performance smoke opt-in：21 passed
