...
> 制定日期：2026-06-10。来源：第一性原理需求重审 + 与维护者的定位讨论。
> （重审文档为 AI 生成的一次性快照，已于 2026-09-22 随其余自评类文档一并删除；
> T11–T16 均已落地，需求追溯以本文件下方的 WP 表为准。）
...
2. `docs/tasks/README.md` 索引表更新 T11–T16 行的完成状态。
