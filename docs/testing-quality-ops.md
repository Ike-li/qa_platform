...
| Audit events 查询 smoke | nightly/manual `tests/integration/test_performance_smoke.py` | `GET /audit-events` p99 smoke，验证真实 DB 审计行、Owner/Admin 权限链路、分页与过滤查询 | 连续 2 次超过阈值，转审计查询/索引专项 |
