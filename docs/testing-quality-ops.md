...
| --- | --- | --- | --- | --- |
| 2026-05-27 | required integration 93 passed；完整 integration 102 passed / 6 skipped；performance smoke 4 passed | unit + coverage 757 passed，coverage 83.32% | 已清理项目内 warning；第三方 testcontainers warning 精确过滤并登记 | 可继续作为 PR 门禁，nightly 承担重型/性能路径 |
