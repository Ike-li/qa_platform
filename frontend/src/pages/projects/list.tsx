    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-ink-subtle">Manage your automation projects and test suites</p>
        </div>
      ...
      {isError ? (
        ...
        <EmptyState 
          ...
          action={{
            label: search ? "Clear search" : "New Project",
            ...
            >
              <div className="flex items-start justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 line-clamp-2 text-sm text-ink-subtle">{project.description || "No description provided."}</p>
                </div>
                <span className={cn(
              ...
              <div className="mt-auto space-y-3">
                ...
                <div className="flex items-center justify-between border-t border-hairline pt-3 text-xs text-ink-tertiary">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>Updated <RelativeTime date={project.updated_at} /></span>
                  </div>
